...
namespace CustomerManagement.Controllers
{
    public class LoginController : Controller
    {
        ...
        public LoginController(CustomerManagement_DBContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Login != null ? 
                          ...
                          Problem("Entity set 'CustomerManagement_DBContext.Login'  is null.");
        }
        ...
        public async Task<IActionResult> Details(int? customerId)
        {
            ...
            if (customer == null || customer.Login == null)
            {
                return NotFound();
            }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'CustomerManagement_DBContext.Login'  is null.");
            }
            var login = await _context.Login.FindAsync(id);
            if (login != null)
            {
